...
from components import character_display, weapon_display, enemy_display, utils, lore_display
from data import character_data, weapon_data, enemy_data, lore_data # Import the data
# --- 1. Basic Setup ---
st.set_page_config(
...
with st.container(border=True):
    ...
    lore_selection = st.selectbox("Select a Lore Section:", list(lore_data.lore_sections.keys()))
    lore_display.display_lore_info(lore_data.lore_sections[lore_selection])
with st.container(border=True):
